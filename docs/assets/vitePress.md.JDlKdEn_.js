import{_ as i,c as a,ag as n,o as l}from"./chunks/framework.DdN-cIJO.js";const c=JSON.parse('{"title":"vitePress","description":"","frontmatter":{"outline":"deep","next":{"text":"埋点","link":"/tracker"}},"headers":[],"relativePath":"vitePress.md","filePath":"vitePress.md","lastUpdated":1738589672000}'),p={name:"vitePress.md"};function t(e,s,h,E,k,d){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="vitepress" tabindex="-1">vitePress <a class="header-anchor" href="#vitepress" aria-label="Permalink to &quot;vitePress&quot;">​</a></h1><h2 id="搭建" tabindex="-1">搭建 <a class="header-anchor" href="#搭建" aria-label="Permalink to &quot;搭建&quot;">​</a></h2><p>控制台输入以下命令</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">npm install vitepress -D</span></span>
